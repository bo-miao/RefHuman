...
def nested_tensor_from_tensor_list(tensor_list: List[Tensor], size_divisibility=16):
    # TODO: This function pads all samples in a batch to a size divisible by 16.
