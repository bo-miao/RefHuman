...
def build_backbone(args):
    ...
    if args.backbone in ['swin_T_224_1k', 'swin_B_224_22k', 'swin_B_384_22k', 'swin_L_224_22k', 'swin_L_384_22k']:
        ...
        backbone = build_swin_transformer(args.backbone, pretrain_img_size=pretrain_img_size, out_indices=tuple(return_interm_indices), dilation=args.dilation, use_checkpoint=use_checkpoint)
        # freeze some layers
        ...
        pretrained_dir = args.swin_pretrain_path
        PTDICT = {
            'swin_T_224_1k': 'swin_tiny_patch4_window7_224_22k.pth',
