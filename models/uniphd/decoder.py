...
'''Copied from Spectrum-guided Multi-granularity Referring Video Object Segmentation (https://github.com/bo-miao/SgMg)'''
...
class MSO(nn.Module):
    ...
    def forward(self, pred_masks, image_features):
        image_features = [x.tensors for x in image_features]
